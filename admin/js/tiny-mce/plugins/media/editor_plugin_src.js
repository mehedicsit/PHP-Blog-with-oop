...
(function() {
	var rootAttributes = tinymce.explode('id,name,width,height,style,align,class,hspace,vspace,bgcolor,type'), excludedAttrs = tinymce.makeMap(rootAttributes.join(',')), Node = tinymce.php.Node,
	...
	tinymce.create('tinymce.plugins.MediaPlugin', {
		...
		/**
		 * Converts a tinymce.php.Node image element to video/object/embed.
		 */
		...
		/**
		 * Converts a tinymce.php.Node video/object/embed to an img element.
		 *
		...
		objectToImg : function(node) {
			...
			function getInnerHTML(node) {
				return new tinymce.php.Serializer({
					inner: true,
					validate: false
				}).serialize(node);
			};
